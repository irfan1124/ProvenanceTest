...
function uuidToBuffer(uuid) {
    ...
    console.log('uuidToBuffer');
    console.log(Buffer(uuid.substr(14, 4) + uuid.substr(9, 4) + uuid.substr(0, 8) + uuid.substr(19, 4) + uuid.substr(24), 'hex'));
    //console.log(Buffer(uuid, 'hex'));
